...
const options = document.querySelector('.answers') as HTMLElement
const questions = document.querySelector('.questions') as HTMLElement
const btn_next = document.querySelector('.btn-next') as HTMLElement 
const btn_prev = document.querySelector('.btn-prev') as HTMLElement 
...
btn_next.addEventListener('click', function(index: number) {
    // let que_tag;
